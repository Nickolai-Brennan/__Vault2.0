...
Use this template when initializing a **CLI Tool** project (command-line utility or developer tool). Answer every question and save the completed file as `PROJECT.md` at the root of your repository.
...
**Secondary Types**: <!-- e.g. Library / SDK, Automation -->
...
**3.1 — What specific problem does this CLI tool solve?**

> **Answer**:

**3.2 — What is the single most important outcome this tool must deliver?**
...
**5.6 — What AI/ML models are used, if any?**
...
**7.1 — What data does the tool read (inputs)?**

> **Answer**:

**7.2 — What data does the tool produce (outputs)?**
...
**7.4 — Does the tool handle PII or secrets?**
Choose one: `true` · `false`

> **Answer**:

**7.5 — What is the data retention policy for logs or caches?**
...
**8.3 — Is there an architecture diagram or command map? Provide a link or file path.**
