# Project Template — AI / LLM / RAG / Chatbot

Use this template when initializing an **AI / LLM / RAG / Chatbot** project (model integration, embeddings, agents). Answer every question and save the completed file as `PROJECT.md` at the root of your repository.

---

## Section 1: Project Type

**Primary Type**: AI / LLM / RAG / Chatbot  
**Secondary Types**: <!-- e.g. API, Web App -->
...
**3.1 — What specific problem does this AI system solve?**

> **Answer**:

**3.2 — What is the single most important outcome this system must deliver?**
...
**4.1 — Who are the primary users of this AI system?**
...
**5.7 — What traditional databases or storage systems are used?**

> **Answer**:

**5.8 — What cloud or infrastructure platforms host this system?**

> **Answer**:

**5.9 — What CI/CD tooling is used?**

> **Answer**:

**5.10 — How is authentication and authorization handled?**
...
**7.1 — What data enters the system (user inputs, documents, data sources)?**
...
**7.4 — Does the system handle PII or PHI?**
Choose one: `true` · `false`

> **Answer**:

**7.5 — What is the data retention policy for conversations and logs?**
...
**8.1 — Describe the high-level AI system architecture in 2–5 sentences.**
