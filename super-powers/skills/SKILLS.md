...
**This is a conceptual skill taxonomy** — a comprehensive catalogue of capability categories and descriptions. It is _not_ a registry of implemented skills. For the list of skills that have been built and are ready to use, see [`skill-registry.md`](./skill-registry.md).
